  ...
  try {
    ...
    if (leadExistente) {
      ...
      const leadAtualizado = await prisma.lead.update({
        ...
        data: {
          ...
          numeroFuncionarios: numeroFuncionarios || leadExistente.numeroFuncionarios,
          cidadeEmpreendimento: cidadeEmpreendimento || leadExistente.cidadeEmpreendimento,
    ...
    const novoLead = await prisma.lead.create({
      data: {
        ...
        cidadeEmpreendimento: cidadeEmpreendimento || '',
