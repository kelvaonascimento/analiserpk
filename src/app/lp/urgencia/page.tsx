...
import { LP_URGENCIA } from '@/lib/lp-content'
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="inline-flex items-center gap-2 bg-red-500/20 border border-red-500/30 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-red-400 font-medium">{LP_URGENCIA.hero.badge}</span>
              </div>

              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
                {LP_URGENCIA.hero.titulo}
              </h1>

              <p className="text-xl text-zinc-400 mb-8">
                {LP_URGENCIA.hero.subtitulo}
              </p>
              ...
              <div className="bg-gradient-to-r from-red-500/20 to-orange-500/20 border border-red-500/30 rounded-xl p-6 mb-8">
                ...
                <p className="text-center text-zinc-400 text-sm mt-4">
                  Tempo para você ter seu diagnóstico completo em mãos
                </p>
              </div>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            ...
            <p className="text-zinc-400">
              Seu passo a passo para ter o diagnóstico completo
            </p>
          </div>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            <Badge className="bg-orange-500/20 text-orange-400 mb-4">Custo da Inação</Badge>
            <h2 className="text-3xl font-bold text-white mb-4">
              {LP_URGENCIA.custoInacao.titulo}
            </h2>
          </div>

          <div className="grid md:grid-cols-2 gap-6">
            {LP_URGENCIA.custoInacao.itens.map((item, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.3, delay: index * 0.1 }}
                className="bg-zinc-900/50 border border-orange-500/20 rounded-xl p-6"
              >
      ...
      <section className="py-16 px-4 bg-zinc-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-white mb-4">
              Além do diagnóstico, você recebe
            </h2>
            <p className="text-zinc-400">
              Benefícios extras para quem age agora
            </p>
          </div>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-xl">
          <div className="text-center mb-8">
            ...
            <p className="text-zinc-400">
              Em 72 horas você terá tudo o que precisa para seu lançamento
            </p>
          </div>
